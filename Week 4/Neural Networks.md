...
- Key Vector ( $K_i$ ): Represents the information available in each token of the sequence. Similar to query vectors, key vectors are generated by multiplying the input embeddings with a weight matrix, $W_k$.
  (i.e Answers the queries of the tokens )

- Value Vector ( $V_i$ ): Contains the actual information to be aggregated. Value vectors are generated by multiplying the input embeddings with a weight matrix $W_V$.
