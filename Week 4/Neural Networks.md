...
- More attention heads means that the dimensions of the information that can be represented is lesser ( i.e less complex information and patterns can be represented )
